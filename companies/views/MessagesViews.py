...
class MessageView(viewsets.ModelViewSet):
    ...
    @action(detail=False, methods=['get'], name="Company Received Messages")
    ...
    @action(detail=False, methods=['get'], name="Company Send Messages")
    ...
    @action(detail=False, methods=['get'], name="User Received Messages")
    ...
    @action(detail=False, methods=['get'], name="User Send Messages")
